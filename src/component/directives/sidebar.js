  ...
  return (
    <>
      ...
      <div className="sidebar">
        ...
        <Link to="/metrics">- The Metrics</Link>
        <Link to="/calendar">- My Calendar</Link>
        <Link to="/designer">- Journey Designer</Link>
        <Link to="/surveymaker">- Survey Maker</Link>
        ...
        {showMenu && (
          <div className="mobile-menus">
            <ul>
              ...
              <li>
                <Link to="/calendar">- Connectors</Link>
              </li>
              ...
              <li>
                <Link to="/connectors">- My Calendar</Link>
              </li>
