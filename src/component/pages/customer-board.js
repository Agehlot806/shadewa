                      ...
                      {CustomerData.map((items, index) => (
                        <tr key={index}>
                          ...
                          <td className="text-center">
                            {" "}
                            {parseInt(items.BusinessValue.slice(1))}
                          </td>
                          ...
                          <td>
                            <div className="contributor-card">
                              {items.Churn <= 26 ? (
                                <button
                                  className="listbuttonChurn"
                                  style={{ backgroundColor: "#50CD89" }}
                                >
                                  {parseInt(items.Churn)}%
                                </button>
                              ) : items.Churn < 41 ? (
                                <button
                                  className="listbuttonChurn"
                                  style={{ backgroundColor: "#F1EA41" }}
                                >
                                  {parseInt(items.Churn)}%
                                </button>
                              ) : (
                          ...
                          <td>
                            <Link to={"/view-more/" + items.id}>View More</Link>
                          </td>
                        </tr>
                      ))}
